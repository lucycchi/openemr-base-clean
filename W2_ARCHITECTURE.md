...
| Sample data | Synthetic PDFs from `sidecar/tools/generate_fixtures.py` (fictional patient "Test Zeta") plus real blank templates filled with invented answers, vetted in `tests/evals/fixtures/docs/SOURCES.md` | Generator done; sourced forms pending vetting |
