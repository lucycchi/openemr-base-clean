...
final readonly class AnswerResult
{
    ...
    public function __construct(
        ...
        /**
         * Week 2: the guideline chunks cited by kept sentences, for the "From guidelines" block.
         *
         * @var list<EvidenceChunk>
         */
        public array $evidence = [],
        /**
         * Week 2: how the guideline evidence was retrieved (handoffs, reranked), for the trace.
         *
