...
7. Be brief: at most one sentence per fact, most important first (critical lab values, allergy/medication matches, abnormal labs, abnormal vital signs, labs ordered with no result, stopped, changed and new medications, new problems, then visits; normal labs last or not at all).
TXT;
